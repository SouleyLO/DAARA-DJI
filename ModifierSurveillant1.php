...
<body>
    ...
    <form action="ModifierSurveillant2.php" method="post" id="myForm">
            <?php
        ...
        <table>
            ...
            <?php foreach($reponse as $surveillant): ?>
                ...
                <th COLSPAN="2">Modification du surveillant <?= $surveillant['Identifiant'] ?></th>

                <tr>
                    <td></td>
                    <td><input type="hidden" name="identifiant" id="Identifiant" value="<?= $surveillant['Identifiant'] ?>"></td>
                    <td><span id="error1"></span></td>
                </tr>
                <tr>
                    <td>NOM</td>
                    <td><input type="text" name="nom"  id="Nom" value="<?= $surveillant['Nom'] ?>"></td>
                    <td><span id="error2"></span></td>
                </tr>
                <tr>
                    <td>PRENOM</td>
                    <td><input type="text" name="prenom" id="Prenom" value="<?= $surveillant['Prenom'] ?>"></td>
                ...
                <tr>
                    ...
                    <td><input type="date" name="date" id="Date" value="<?= $surveillant['Date_Naissance'] ?>"></td>
                    <td><span id="error5"></span></td>
                </tr>
                <tr>
                    <td>MAIL</td>
                    <td><input type="email" name="mail" id="Mail" value="<?= $surveillant['Mail'] ?>"></td>
                    <td><span id="error6"></span></td>
                </tr>
                <tr>
                    <td>ADRESSE</td>
                    <td><input type="text" name="adresse" id="Adresse" value="<?= $surveillant['Adresse'] ?>"></td>
